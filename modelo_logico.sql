...
CREATE TABLE empleado (
    ...
    cod_sucursal number(8),  -- restricción 3: los directores NO “trabajan” en ninguna sicursal -> no se les asocia ninguna 
...
-- AÑADO LA RESTRICCION DE LLAVE EXTERNA de sucursal en empleado
ALTER TABLE empleado
	ADD CONSTRAINT FK_SUCURSAL FOREIGN KEY (cod_sucursal) REFERENCES sucursal(cod_sucursal)
;
